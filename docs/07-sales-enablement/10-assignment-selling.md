---
title: "Assignment Selling"
description: "Requiring prospects to consume educational content before sales calls to improve close rates and reduce sales cycles."
tags: ["sales-enablement", "assignment-selling", "sheridan", "active"]
...
### Pre-Discovery Call
1. Founder/team bio video (2-3 min) — Who we are
2. What to expect video (5-10 min) — Full process
3. Pricing guide (blog) — Realistic budgets
4. Reviews page — Social proof

### Pre-Estimate Presentation
1. Case study similar to their project (video or blog)
2. Process deep-dive (blog) — Pre-construction, communication
3. Value explanation (blog) — "Why We Cost What We Cost"

### Pre-Contract Signing
1. Client testimonial (video) — Similar project
2. Problem handling (blog) — Warranty, resolution
3. Timeline/disruption guide — What to expect during
...
> Please watch/read:
> 1. [Bio video link]
> 2. [What to expect video link]
> 3. [Pricing guide link]
> 4. [Reviews page link]
>
...
- **Read:** [Revenue Team Model](../01-foundations/01-the-revenue-team-model) — How this fits into team structure
- **Read:** [Big 5 Content](../05-content/16-answering-hard-questions) — What content to create
- **Read:** [Buyer Journey Mapping](../05-content/buyer-resources/00-buyer-journey-mapping) — Content-to-stage alignment
- **Resource:** [Marcus Sheridan's Endless Customers](../endless-customers-full-book) — Chapters 8-10 on Assignment Selling
