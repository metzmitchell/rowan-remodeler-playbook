...
description: "Revenue-focused metrics for builders and remodelers - track what drives business."
tags: ["analytics", "kpis", "active"]
...
**See:** [Analytics Dashboards](./dashboards/) for templates

---

## Learn More

- **Read:** [Allowable CPA](./05-allowable-cpa) - Calculate your maximum CPA
- **Read:** [Conversion Rates Reference](./04-conversion-rates-reference) - Industry benchmarks
- **Tool:** [KPI Dashboard Templates](./dashboards/) - Pre-built tracking dashboards
