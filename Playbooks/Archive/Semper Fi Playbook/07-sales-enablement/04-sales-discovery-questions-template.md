...
description: "Big 5-aligned discovery questions to uncover buyer priorities, budget, timeline, and decision criteria."
tags: ["sales-enablement", "discovery", "active"]
...
- **Read:** [Assignment Selling](10-assignment-selling.md) — Full framework
- **Read:** [Big 5 Content](../05-content/16-answering-hard-questions.md) — What content to assign
- **Tool:** Full discovery call script template (create in templates)
- **Resource:** [Semper Fi Org Structure](../../Org Structure/Semper Fi Marketing Org Structure.md) — Sales process flow
